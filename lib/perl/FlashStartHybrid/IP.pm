...
sub ip_add_num {
    ...
    my $new = new FlashStartHybrid::IP("$newb - $newe");
...
sub binadd {
    ...
    my $new = new FlashStartHybrid::IP(ip_bintoip($ip, $self->version())) or return;
...
sub aggregate {
    ...
    return (new FlashStartHybrid::IP($r));
}
